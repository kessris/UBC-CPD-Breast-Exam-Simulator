...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"selection\"][\"selection\"]]")]
	public abstract partial class PlayerBehavior : NetworkBehavior
	{
		public const byte RPC_EXAMINE = 0 + 5;
		public const byte RPC_SYNCH_ACTION = 1 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("Examine", Examine, typeof(int));
			networkObject.RegisterRpc("SynchAction", SynchAction, typeof(int));
		...
		/// int selection
		/// </summary>
		public abstract void Examine(RpcArgs args);
		/// <summary>
		/// Arguments:
		/// int selection
		/// </summary>
		public abstract void SynchAction(RpcArgs args);
