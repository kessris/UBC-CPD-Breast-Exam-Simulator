...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class PlayerNetworkObject : NetworkObject
	{
		...
		[ForgeGeneratedField]
		private int _speed;
		public event FieldEvent<int> speedChanged;
		public Interpolated<int> speedInterpolation = new Interpolated<int>() { LerpT = 0f, Enabled = false };
		public int speed
		{
			get { return _speed; }
			set
		...
		protected override void ReadPayload(BMSByte payload, ulong timestep)
		{
			...
			_speed = UnityObjectMapper.Instance.Map<int>(payload);
		...
		protected override void ReadDirtyFields(BMSByte data, ulong timestep)
		{
			...
			if ((0x4 & readDirtyFlags[0]) != 0)
			{
				...
				{
					speedInterpolation.target = UnityObjectMapper.Instance.Map<int>(data);
					speedInterpolation.Timestep = timestep;
				}
				else
				{
					_speed = UnityObjectMapper.Instance.Map<int>(data);
					RunChange_speed(timestep);
				}
			}
		}
		...
		public override void InterpolateUpdate()
		{
			...
			{
				_speed = (int)speedInterpolation.Interpolate();
