			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case CubeForgeGameNetworkObject.IDENTITY:
						...
						break;
					case DoctorNetworkControllerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new DoctorNetworkControllerNetworkObject(networker, id, frame);
						break;
					case DoorNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new DoorNetworkObject(networker, id, frame);
						break;
					...
					case NetworkCameraNetworkObject.IDENTITY:
						...
						break;
					case PauseScreenNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PauseScreenNetworkObject(networker, id, frame);
						break;
					case PlayerNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new PlayerNetworkObject(networker, id, frame);
						break;
					case SimplePictureNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new SimplePictureNetworkObject(networker, id, frame);
						break;
					case TestNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new TestNetworkObject(networker, id, frame);
						break;
					case ObserverNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ObserverNetworkObject(networker, id, frame);
						break;
				}
