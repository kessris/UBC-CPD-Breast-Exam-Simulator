...
public class VivoxVoiceManager : MonoBehaviour
{
    ...
    [SerializeField]
    private string _tokenIssuer = "daniel7181-ub98-dev";
    [SerializeField]
    private string _tokenKey = "zinc567";
    ...
    {
        GameObject.Find("VivoxVoiceManager").GetComponent<VivoxManager>().speakingIndicator.SetActive(isSpeaking);  
    }
